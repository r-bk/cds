...
macro_rules! array_vec {
    ($c:expr; $t:ty) => {{
        cds::arrayvec::ArrayVec::<$t, cds::len::Usize, cds::mem::Uninitialized, $c>::new()
    }};
    ($c:expr; $t:ty; $($e:expr),+ $(,)?) => {{
        cds::arrayvec::ArrayVec::<$t, cds::len::Usize, cds::mem::Uninitialized, $c>::try_from([$($e),*])
            .expect("insufficient capacity")
    }};
    ($c:expr;) => {{
        cds::arrayvec::ArrayVec::<_, cds::len::Usize, cds::mem::Uninitialized, $c>::new()
    }};
    ($c:expr; $($e:expr),+ $(,)?) => {{
        cds::arrayvec::ArrayVec::<_, cds::len::Usize, cds::mem::Uninitialized, $c>::try_from([$($e),*])
            .expect("insufficient capacity")
    }};
}
